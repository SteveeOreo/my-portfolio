      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-10">
          <motion.a
            ...
            className="group relative overflow-hidden bg-primary-2000 hover:bg-primary-700 text-white px-10 py-5 text-lg font-bold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 inline-flex items-center justify-center min-w-[200px] border-2 border-transparent hover:border-primary-400"
